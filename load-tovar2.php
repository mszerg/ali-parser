            ...
            foreach ($order->find('.order-body') as $product) {
                ...
                if ($rows == 1) { //zapis uge est', update him
                    ...
                    $query = "INSERT INTO tbl_order_tovar VALUES" .
                        "('', '$int_order', '$blob_picture', '$int_ali_id_tovar','" . mysql_escape_mimic($txt_name_tovar) . "', \"$txt_manager\", '$dec_price', '$int_count', '$int_count', '" . mysql_escape_mimic($txt_status_otmeni) . "', '$txt_snapshot_num', '$bl_mobile')";
